      ...
      {showNew && (
        <div className="modal-overlay" onClick={() => setShowNew(false)}>
          <div
            ...
            style={{ background: 'var(--color-card)', borderTop: '1px solid var(--color-border)', borderRadius: '16px 16px 0 0', padding: '24px', width: '100%', maxWidth: '430px', maxHeight: '90vh', overflowY: 'auto' }}
          >
